...
class _State extends State<ContentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        picUrl:
            'https://img.vixdata.io/pd/jpg-large/es/sites/default/files/btg/tech.batanga.com/files/Redes-Sociales-para-los-amantes-del-cine-4.jpg',
        tile: const Text("SIGNAL TV"),
        context: context,
        onSignOff: () {
          Get.offNamed('/auth');
        },
